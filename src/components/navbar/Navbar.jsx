...
const Navbar = () => {
  ...
  return (
    <div className=' flex justify-between items-center p-5 mb-5 bg-white'>
        ...
        <div className='flex gap-5 items-center '>
            ...
            <div onClick={()=>{setToggle(!toggle)}} className='relative '>
                ...
                {toggle && 
                <div className={`${toggle ?"absolute" : "hidden"} top-12 right-5  p-2 bg-secoundary w-60 z-20 rounded-md text-white`}>
                    <div className='absolute top-0 right-3 bg-secoundary w-4 h-4 translate-y-[-7px] -rotate-45 '></div>
