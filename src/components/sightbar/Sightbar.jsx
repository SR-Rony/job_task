  ...
  return (
    <div className=' p-5 w-full h-screen bg-white'>
        <div className='flex justify-between items-center mb-5'>
            ...
            <div className='flex bg-bg_primary w-7 h-7 justify-center items-center rounded-md text-[#9da4ae] cursor-pointer'>
                <LiaAngleLeftSolid/>
                <LiaAngleRightSolid />
            </div>
        </div>
        <List>
            <Link to="/"  onClick={()=>setUrl("home")}>
                <div className={` ${url=="home" && "bg-primary text-white ml-[0px]"} flex ml-3 my-2 hover:ml-0 gap-2 items-center text-xl text-secoundary p-2 hover:bg-primary hover:text-white rounded-md duration-100`}>
                    <RiHome6Line/>
